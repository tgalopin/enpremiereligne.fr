...
const HiddenInputs = ({needGroceries, needBabysit, children}) => {
    ...
    if (needBabysit) {
        for (let i in children) {
            inputs.push(
                <div key={'input-' + key}>
                    <input type="hidden" name={'composite_help_request[details][' + key + '][helpType]'}
                           value="babysit"/>
                    <input type="hidden" name={'composite_help_request[details][' + key + '][childAgeRange]'}
                                ...
                                <div className="mb-2" key={key + '-' + child.age}>
                                    ...
                                    <div className="row no-gutters">
                                        ...
                                        <div className="col-2 text-center">
                                            <button type="button"
                                                    className={'btn btn-link ' + (key === 0 ? 'd-none' : '')}
